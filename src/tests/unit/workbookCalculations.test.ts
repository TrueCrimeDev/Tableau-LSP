...
describe('workbook calculated-field mutation', () => {
    it.each([
        '<foreign><!-- <workbook><datasources> --></foreign>',
        '<workbook/><datasources/>',
        '<foreign><workbook><datasources/></workbook></foreign>',
        '<workbook><metadata><datasources/></metadata></workbook>',
    ...
    it('allows normal declarations, comments and unknown workbook metadata', () => {
        expect(() => validateWorkbookXml(`<?xml version="1.0" encoding="utf-8"?>
            <!-- A workbook --><?generated by="Tableau"?>
            <workbook><datasources/><unknown><nested/></unknown></workbook>`)).not.toThrow();
    });
