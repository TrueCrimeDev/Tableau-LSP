...
export class ConditionalExpressionValidator {
    ...
    private validateIfStatement(symbol: Symbol, document: TextDocument): void {
        ...
        // Performance/complexity warnings removed
    }
    
    /**
     * Validate nesting complexity - REMOVED to avoid performance warnings
    ...
    /**
     * Calculate nesting depth - REMOVED to avoid performance warnings
     * @deprecated - No longer used
     */
