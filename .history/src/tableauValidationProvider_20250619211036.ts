...
import { TableauDocumentManager, TableauExpression } from "./tableauDocumentModel";
...
export default class TableauValidationProvider {
    ...
    private validateExpression(
        ...
        const expression = documentModel.expressions.find((expr: TableauExpression) =>
        ...
        if (tableauProvider) {
            for (const match of Array.from(functionMatches)) {
                ...
                const functionName = matchArray[1].toUpperCase();
