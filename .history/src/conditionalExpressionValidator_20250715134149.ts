...
export class ConditionalExpressionValidator {
    ...
    private validateIfStatement(symbol: Symbol, document: TextDocument): void {
        ...
        // R2.3: Nesting complexity validation disabled - no performance warnings
        // this.validateNestingComplexity(symbol);
    }
    
    /**
     * R2.3: Validate nesting complexity - DISABLED to avoid performance warnings
     * @deprecated - Removed to prevent performance/complexity warnings in .twbl files
     */
    private validateNestingComplexity(symbol: Symbol): void {
        // No-op - performance warnings removed
    }
    
    /**
     * Calculate nesting depth of conditional expressions - DISABLED
     * @deprecated - No longer used for performance warnings
     */
    private calculateNestingDepth(symbol: Symbol): number {
        return 0; // Always return 0 to avoid warnings
    }
