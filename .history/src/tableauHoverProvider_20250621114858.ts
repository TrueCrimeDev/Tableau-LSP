    ...
    private addContextAwareInformation(
        ...
        switch (symbol.type) {
            ...
            case 'keyword':
                ...
                if (symbol.syntax) {
                    // Use dynamically parsed syntax from the definition file
                    markdownString.appendMarkdown('\n\n**Syntax:**');
                    markdownString.appendCodeblock(symbol.syntax, 'tableau');
                } else {
                    // Generic keyword handling for keywords without syntax
