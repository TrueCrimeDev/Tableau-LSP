...
type DebouncedFunc<T extends (...args: unknown[]) => void> = T;
...
export default class TableauDiagnosticsProvider {
    ...
    private doSyntaxCheck: DebouncedFunc<(change: vscode.TextDocumentChangeEvent) => void>;
