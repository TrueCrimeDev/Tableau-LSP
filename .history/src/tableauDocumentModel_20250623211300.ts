    ...
    private extractSymbols(): void {
        for (const expression of this._parsedExpressions) {
            ...
            for (const match of functionMatches) {
                ...
                this._addSymbolContext(functionName, 'function', expression, match[0], match.index || 0);
            }
            ...
            for (const match of fieldMatches) {
                ...
                this._addSymbolContext(fieldName, 'field', expression, match[0], match.index || 0);
            }
            ...
            for (const match of keywordMatches) {
                ...
                this._addSymbolContext(keyword, 'keyword', expression, match[0], match.index || 0);
            }
        }
    }
