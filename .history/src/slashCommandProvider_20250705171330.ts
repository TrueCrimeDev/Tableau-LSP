 ...
 * @property {string} prefix - The slash command trigger (e.g. "/if")
 * @property {string} description - Description of the snippet
 * @property {string[]|string} body - Snippet body (array or string)
 */

/**
 * Type guard for SlashCommand objects.
 * @param {any} obj
 * @returns {obj is SlashCommand}
 */
 ...
 * Provides slash command completions and snippet insertion for Tableau-LSP.
 * @class
