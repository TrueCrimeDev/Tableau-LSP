...
// Import real extension logic from compiled JS in out/
const { TableauProvider } = require('./out/tableauProvider');
const { TableauHoverProvider } = require('./out/tableauHoverProvider');
const { TableauDocumentManager } = require('./out/tableauDocumentModel');
